  ...
  return (
    <div className="min-h-screen lg:grid lg:grid-cols-[0.96fr_1.04fr]" style={{ background: 'var(--sl-bg)' }}>
      ...
      <div className="relative min-h-screen px-6 py-10 md:px-10 lg:px-14 xl:px-18" style={{ background: 'var(--sl-surface)' }}>
        ...
        {sessionClosed ? (
          <div className="mx-auto mt-4 w-full max-w-[500px] rounded-2xl border border-emerald-200 bg-emerald-50 px-4 py-3 text-sm text-emerald-800 dark:border-emerald-800 dark:bg-emerald-500/10 dark:text-emerald-300 md:mt-12">
